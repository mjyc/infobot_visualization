#ifndef INFOBOT_RVIZ_LONGTERM_POINT_CLOUD_LONGTERM_H
#define INFOBOT_RVIZ_LONGTERM_POINT_CLOUD_LONGTERM_H
...
class PointCloudLongTerm: public QObject
{
  Q_OBJECT
public:
  struct CloudInfo
  ...
  explicit PointCloudLongTerm(rviz::Display* display);
  ~PointCloudLongTerm();
...
#endif  // INFOBOT_RVIZ_LONGTERM_POINT_CLOUD_LONGTERM_H
